...
- [summer-rs 文档](/zh/)
- [插件系统](/zh/docs/plugins/plugin-by-self/)
- [依赖注入](/zh/docs/getting-started/di/)
- [配置系统](/zh/docs/getting-started/config/)
- [示例项目](https://github.com/summer-rs/summer-rs/tree/main/examples/component-macro-example)
