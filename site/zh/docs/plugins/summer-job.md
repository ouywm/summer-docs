...
你可以用[`Config`](https://docs.rs/summer-job/latest/summer_job/extractor/struct.Config.html)抽取toml中的配置。用法上和[`summer-web`](/zh/docs/plugins/summer-web/#du-qu-pei-zhi)完全一致。
