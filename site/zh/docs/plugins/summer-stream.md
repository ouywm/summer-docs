---
title: "summer-stream插件"
description: "summer-stream插件如何使用"
---
...
你可以用[`Config`](https://docs.rs/summer-stream/latest/summer_stream/extractor/struct.Config.html)抽取toml中的配置。用法上和[`summer-web`](/zh/docs/plugins/summer-web/#du-qu-pei-zhi)完全一致。
