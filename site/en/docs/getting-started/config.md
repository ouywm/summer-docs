...
description: "summer-rs implements a concise configuration loading function"
---
...
* [`summer-web`](/docs/plugins/summer-web/#read-configuration)
* [`summer-job`](/docs/plugins/summer-job/#read-configuration)
* [`summer-stream`](/docs/plugins/summer-stream/#read-configuration)
