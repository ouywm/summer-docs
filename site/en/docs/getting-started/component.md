...
- [summer-rs Documentation](/)
- [Plugin System](/docs/plugins/plugin-by-self/)
- [Dependency Injection](/docs/getting-started/di/)
- [Configuration](/docs/getting-started/config/)
- [Example Project](https://github.com/summer-rs/summer-rs/tree/main/examples/component-macro-example)
